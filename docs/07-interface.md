...
1. **顶部状态栏**：显示楼层、等级和金币；右侧提供圣遗物图鉴、天赋图鉴、角色、帮助、设置和日志按钮。顶部不显示全局回合或体力数值。
2. **提示与经验区**：显示下一次攻击增益、中毒／燃烧状态和经验进度。
3. **三维棋盘**：显示正方形卡牌、角色、敌人、物品、陷阱、NPC、门和路径预览。
4. **下方面板**：圣遗物竖向放在背包左侧，与背包 5 行格子对齐；背包为横向 5 行 × 8 列。
...
长按棋盘对象或背包物品打开详情面板，显示其名称、类别、属性、数值和效果。角色面板显示等级、经验、生命上限和天赋数量；天赋面板显示 10 条主线的三层节点状态。帮助、圣遗物、角色、天赋、设置和日志都是独立面板，不向棋盘透传点击。

商人面板显示购买、出售和圣遗物服务。购买、出售、刷新货架及圣遗物配置均为即时操作，不推进回合。
