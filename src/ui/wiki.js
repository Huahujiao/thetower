...
const COPY = Object.freeze({
  ...
  inventoryEffectNote: 'Backpack effect feedback: each accessory is joined to every actual beneficiary by one short, two-layer green flow crossing a real shared cell edge. Irregular shapes use occupied cells, links ignore touches and hide during dragging. Conditional relics are dim while unmet and bright when ready; triggerless relics stay bright.',
  ...
  equipmentUpgradeNote: 'Equipment details show each forward crafting upgrade as one neutral icon-only row: source + ingredient -> result. Icons have no names, attribute colors, or detail gestures; multiple recipes become multiple rows.',
  implemented: '\u5df2\u5b9e\u88c5',
  back: '\u8fd4\u56de\u5730\u7262',
  enemies: '\u654c\u4eba',
  traps: '\u9677\u9631',
