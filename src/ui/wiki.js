...
const COPY = Object.freeze({
  ...
  equipmentUpgradeNote: 'Equipment details show each forward crafting upgrade as one frameless, background-free contain-fitted icon row: source + ingredient -> result. The plus and arrow are CSS marks; icons have no names, attribute colors, or detail gestures, and multiple recipes become multiple rows.',
  implemented: '\u5df2\u5b9e\u88c5',
  back: '\u8fd4\u56de\u5730\u7262',
  enemies: '\u654c\u4eba',
  traps: '\u9677\u9631',
